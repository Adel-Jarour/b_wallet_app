...
class CustomRequestToUser extends StatelessWidget {
  const CustomRequestToUser({super.key});
...
class _RequestToElement extends StatelessWidget {
  final UserProfileModel user;

  const _RequestToElement({required this.user});
