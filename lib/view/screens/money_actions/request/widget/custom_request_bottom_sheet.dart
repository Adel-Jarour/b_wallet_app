...
import 'package:b_wallet/view/screens/money_actions/request/widget/custom_request_select_category_bottom_sheet.dart';
import 'package:b_wallet/view/screens/money_actions/request/widget/custom_request_to_user.dart';
import 'package:b_wallet/view/screens/money_actions/send/widget/custom_number_of_send_bottom_sheet.dart';
...
class CustomRequestBottomSheet extends StatelessWidget {
  CustomRequestBottomSheet({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomNumberOfSendBottomSheet(
            number: controller.number,
          ),
          SizedBox(
            height: 16.h,
          ),
          CustomRequestSelectCategoryBottomSheet(),
          SizedBox(
            height: 32.h,
          ),
          CustomText(
          ...
          const Expanded(child: CustomRequestToUser()),
          SizedBox(
            height: 36.h,
          ),
          CustomButton(
