...
class CustomSendSelectCategoryBottomSheet extends StatelessWidget {
  CustomSendSelectCategoryBottomSheet({super.key});
    ...
    return InkWell(
      onTap: () {
        showModalBottomSheet(
          ...
          elevation: 0,
          builder: (_) => _CustomSendSelectCategory(),
        );
      },
      child: Container(
        height: 48.h,
...
class _CustomSendSelectCategory extends StatelessWidget {
  _CustomSendSelectCategory();
